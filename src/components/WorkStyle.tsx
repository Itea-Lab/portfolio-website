  ...
  return (
    <section id="workstyle" className="py-20 bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <h2
          className={`text-3xl font-bold text-center text-[#004243] mb-6 transition-opacity duration-2000 ${
        ...
        <p
          className={`text-lg text-center max-w-3xl mx-auto mb-16 transition-opacity duration-2000 ${
            isVisible ? "opacity-100" : "opacity-0"
          }`}
        >
          {t("workStyle.intro")}
        ...
        <div
          className={`grid md:grid-cols-2 gap-x-12 gap-y-16 max-w-5xl mx-auto transition-opacity duration-2000 ${
            isVisible ? "opacity-100" : "opacity-0"
          }`}
        >
