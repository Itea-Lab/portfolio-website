  ...
  const items = [
    {
      ...
      content: "Nguyen Vinh Khang (ITea Lab Gen 1) and Truong Duc Sang (ITea Lab Gen 2) were featured in Thanh Nien newspaper for developing an AI tool that identifies online scam websites. This is part of the Chongluadao.vn project, founded by cybersecurity expert Mr. Ngo Minh Hieu. \n Lab would like to send our best wishes to them and hope them with a further success on their path.",
      alt: "ITea News image",
    ...
    },
    {
      ...
      content: "ITea Lab is excited to partner with 3DIoT - the leading community with mutual passion, knowledge on IoT, especially in embedded technology. With ITea Lab’s strength in software development and operations, we are aiming to exchange knowledge, organize valuable workshops, and collaborate on projects together.",
      alt: "ITea News image",
      url: "https://www.facebook.com/ITeaLabTeam",
    },
  ];
  ...
  return (
    <section className="py-20 bg-[#F9FAFB]" id="news">
      <div className="container mx-auto px-4">
        <h2
          className={`text-3xl md:text-4xl font-bold max-w-7xl mx-auto text-[#004243] mb-6 py-10 transition-opacity duration-1000 ${
          ...
          {items.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                <Link
                  to={item.url}
                  className="inline-flex items-center text-md font-medium text-[#44a3a2] hover:text-[#44a3a2] transition-colors group"
                >
